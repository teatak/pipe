...
LDFLAGS="-X github.com/teatak/pipe/common.Type=${TYPE} -X github.com/teatak/pipe/common.GitSha=${GITSHA} -X github.com/teatak/pipe/common.GitBranch=${GITBRANCH} -X github.com/teatak/pipe/common.Version=${VERSION}"
